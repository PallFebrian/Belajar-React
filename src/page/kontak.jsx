                  ...
                  <div className="flex items-center w-full pr-3">
                    <div className="w-[50px] h-[50px] bg-blue-400 rounded-full mr-5">
                      {/* <img
                        ...
                        src="https://bridalshower101.com/wp-content/uploads/2020/08/aesthetic-background-7.png"
                        alt=""
                      /> */}
                    </div>
                    <div className="flex flex-col justify-between border-b border-b-[#222d34] py-3 w-full">
                      <div>
                        ...
                        <h1 className="text-[#e3e7e5] font-bold">broo</h1>
                        <p className='text-[#00a884]'>00:00</p>
                        </div>

                        <div className='flex justify-between items-center'>
                          <div className='flex items-center'>
                            <BsCheck2All color='#53bdeb' size={20} className="mr-1"/>
                            <p className="text-[#869695]">Tikum dmne pep?</p>
                          </div>
                        <p className='bg-[#00a884] px-2 rounded-full text-[13px]'>3</p>
                        </div>
                      </div>
                    </div>
                  </div>
